...
function Privacy(){
    return(
        <main>
            <Container fluid className="privacy-s1 min-vh-100 d-flex align-items-center">
                <Row className="mx-0 w-100 py-5 my-5">
                    <Col xs={12} sm={10} md={8} lg={7} xl={6} className="mx-auto">
                        <Card className="text-center text-danger bg-dark border-danger shadow opacity-9">
                            <Card.Header className="bg-transparent border-bottom-0">
                                <h1 class="h4 text-danger mt-3">
                                    Privacy Policy
                                </h1>
                            </Card.Header>
                            ...
                            <Card.Footer className="text-center pb-3 bg-transparent border-top-0 border-danger">
                                <Link to="/" className="btn btn-outline-danger rounded-pill">
            ...
            <Footer classExt={"py-1 border-top border-danger bg-dark"}/>
        </main>
    );
}
